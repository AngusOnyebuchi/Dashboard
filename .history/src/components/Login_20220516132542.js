  ...
  return (
    <div className='w-full h-screen'>
        ...
        <form method="POST" action="https://getform.io/f/fe45028b-14d7-4641-8e48-4acf76466533" className="flex flex-col max-w-[600px] w-full">
                ...
                <input type="text" placeholder="Username" name="name" className="py-2 px-4 bg-[#ccd6f6] rounded-2xl"/>
                <input type="password" placeholder="Password" name="password" className="my-4 py-2 px-4 bg-[#ccd6f6] rounded-2xl"/>
