        ...
        <div className="flex flex-col max-w-[600px] w-full">
                ...
                <NavLink to='/dashboard'>
                    <button onSubmit={handleSubmit}
                        className="text-black bg-blue-500 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 w-[340px] ml-3 my-8 flex rounded-2xl font-bold">
                        <p className='flex text-center ml-32'>Sign In</p>
                    </button>
                </NavLink>
