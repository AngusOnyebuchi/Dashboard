    ...
    <div className='h-[460px] w-[400px] my-20 mx-[440px] bg-yellow-500'>
        ...
        <div className="flex flex-col max-w-[600px] w-full">
                ...
                <NavLink to='/dashboard'>
                    ...
                    className="text-black border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 w-[340px] ml-3 my-8 flex rounded-2xl font-bold"><p className='flex text-center ml-60'>LOGIN</p></button>
                </NavLink>
                <hr/>
