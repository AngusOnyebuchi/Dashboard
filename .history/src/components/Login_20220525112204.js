    ...
    <div className='h-[560px] w-[600px] my-8 mx-[340px] bg-yellow-500'>
        ...
        <div className="flex flex-col max-w-[600px] w-full">
                ...
                <NavLink to='/dashboard'>
                    ...
                    className="text-black border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 w-[480px] ml-8 my-8 flex rounded-2xl font-bold w-[595px] "><p className='flex text-center ml-60'>LOGIN</p></button>
                </NavLink>
