  ...
  return (
    ...
    <div className='h-[460px] w-[400px] my-20 mx-[440px] bg-white'>
        ...
        <div className='flex gap-6 items-center ml-4 p-8'>
            <div>
                <p className='text-sm border-2 border-blue-500 text-black p-2'><strong>AD</strong></p>
            </div>
        ...
        <div className="flex flex-col max-w-[600px] w-full">
                ...
                <NavLink to='/dashboard'>
                    <button onSubmit={handleSubmit}
                        className="text-black bg-blue-500 hover:bg-blue-900 hover:border-pink-600 px-4 py-3 w-[340px] ml-3 my-8 flex rounded-xl font-bold">
