    ...
    return (
        <div name="register">
            ...
            <form method="POST" action="https://getform.io/f/fe45028b-14d7-4641-8e48-4acf76466533" className="flex flex-col max-w-[600px] w-full">
                ...
                />
                <label htmlFor="joinNewsletter" className="ml-7">I want to join the newsletter</label>
                </div>
                ...
                <div className='flex justify-between items-center gap-12 text-md text-black mt-4 px-2'>
