    ...
    <div className='w-full h-screen'>
        ...
        <form method="POST" action="https://getform.io/f/fe45028b-14d7-4641-8e48-4acf76466533" className="flex flex-col max-w-[600px] w-full">
                <div className="pb-8 mt-12 pt-8">
                    <p className="text-4xl font-bold inline border-b-4 border-pink-600 text-gray-200">Dashboard</p>
                ...
                <input type="text" placeholder="Username" name="name" className="p-2 text-white bg-[#ccd6f6]"/>
                <input type="password" placeholder="Password" name="password" className="my-4 p-2 text-white bg-[#ccd6f6]"/>
