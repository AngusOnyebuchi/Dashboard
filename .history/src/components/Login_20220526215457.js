  ...
  return (
    ...
    <div className='h-[460px] w-[400px] my-8 mx-[340px] bg-yellow-500'>
        ...
        <div className='flex gap-2 items-center p-8'>
            <div>
                <p className='text-sm border-4 border-black text-black p-2'><strong>AD</strong></p>
            </div>
        ...
        <div className="flex flex-col max-w-[600px] w-full">
                <input 
                    ...
                    value={user.email}
                    className="py-2 px-8 bg-[#ccd6f6] w-[340px] ml-8 rounded-xl border-2 border-gray-700"
                />
                <input 
                    type="password" 
                    ...
                    onChange={handleChange}
                    value={user.password}
                    className="my-4 py-2 px-8 bg-[#ccd6f6] w-[340px] ml-8 rounded-xl border-2 border-gray-700"
                />
                ...
                <NavLink to='/dashboard'>
                    ...
                    className="text-black border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 w-[340px] ml-8 my-8 flex rounded-2xl font-bold"><p className='flex text-center ml-60'>LOGIN</p></button>
                </NavLink>
