  ...
  return (
    <div name="login" className='w-full h-screen'>
        ...
        <div className="flex flex-col max-w-[600px] w-full">
                ...
                />
                <a href='/dashboard'>
                    <button className="text-black border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 my-8 flex rounded-2xl font-bold w-[595px] "><p className='flex text-center ml-20'>LOGIN</p></button>
                </a>
