...
export default function Login() {
  ...
  return (
    ...
    <div className='h-[460px] w-[400px] my-20 mx-[440px] bg-white'>
        ...
        <div className='flex gap-6 items-center ml-4 mt-8 mb-8 p-8'>
            <div>
                <p className='text-sm border-2 border-blue-900 text-blue-900 p-2'><strong>AD</strong></p>
            </div>
        ...
        <div className="flex flex-col max-w-[600px] w-full">
                <input 
                    ...
                    value={user.email}
                    className="py-2 px-8 bg-[#ccd6f6] w-[340px] ml-3 rounded-xl border-1 border-gray-700"
                />
                <input 
                    type="password" 
                ...
                <NavLink to='/dashboard'>
                    <button onSubmit={handleSubmit}
                        className="text-black bg-blue-900 hover:bg-blue-500 px-4 py-3 w-[340px] ml-3 my-8 flex rounded-xl font-bold">
                        <p className='flex text-center text-white ml-32'>Sign In</p>
                    </button>
                </NavLink>
                

                <div className='flex items-center gap-4 text-sm mx-16 mt-2'>
