        ...
        <div name="register">
            ...
            <form method="POST" action="https://getform.io/f/fe45028b-14d7-4641-8e48-4acf76466533" className="flex flex-col max-w-[600px] w-full">
                ...
                <button onSubmit={handleSubmit}
                    className="text-black bg-blue-900 hover:bg-blue-600 px-4 py-3 my-8 flex rounded-2xl font-bold w-[595px] "><p className='flex text-center ml-52'>Create Account</p></button>
