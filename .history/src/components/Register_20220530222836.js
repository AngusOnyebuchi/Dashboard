        ...
        <div name="register">
            ...
            <form method="POST" action="https://getform.io/f/fe45028b-14d7-4641-8e48-4acf76466533" className="flex flex-col max-w-[600px] w-full">
                ...
                <input 
                    ...
                    className="py-2 px-8 bg-[#ccd6f6] w-[340px] ml-8 mb-2 rounded-lg border-2 border-gray-700"
                    />
                <input 
                    type="text" 
                ...
                <button onSubmit={handleSubmit}
                    className="bg-blue-900 hover:bg-blue-500 px-4 py-3 w-[340px] ml-8 my-4 flex rounded-lg font-bold">
                    <p className='flex text-center text-white ml-32'>Sign Up</p>
                </button>

                <div className='flex items-center gap-4 text-md text-black px-8'>
                    <p className="ml-16">Already have an account?</p>
