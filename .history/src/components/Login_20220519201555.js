    ...
    <div name="login" className='w-full h-screen'>
        ...
        <div className='flex justify-between items-center p-8'>
            ...
            <div className='flex items-center gap-4'>
                <NavLink href='/register'><p className='cursor-pointer'>Register/Create Account</p></NavLink>
            </div>
        </div>
        ...
        <div className="flex flex-col max-w-[600px] w-full">
                ...
                <div className='flex justify-between items-center gap-12 text-xl mt-4'>
                    <NavLink href='/createAccount'><p>CREATE ACCOUNT</p></NavLink>
                    <NavLink href='/'><p>Forgot password?</p></NavLink>
                </div>
