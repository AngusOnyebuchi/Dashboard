        ...
        <div name="register">
            <div className='ml-[350px]'>
              <form method="POST" action="https://getform.io/f/fe45028b-14d7-4641-8e48-4acf76466533" className="flex flex-col max-w-[600px] w-full">
                ...
                <button className="text-black border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 my-8 flex rounded-2xl font-bold w-[595px] "><p className='flex text-center ml-52'>Create Account</p></button>

                <div className='flex justify-between items-center gap-12 text-xl text-black mt-4 px-2'>
                    <NavLink href='/'><p>Back to Login Page</p></NavLink>
                    <NavLink href='/'><p>Terms of Use</p></NavLink>
                </div>
